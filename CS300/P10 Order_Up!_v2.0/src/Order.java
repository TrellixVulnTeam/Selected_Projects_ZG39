...
public class Order implements Comparable<Order> {
  ...
  /**
   * Implement the Comparable<Order> interface and any required methods such that two Orders are
   * equal if their prepTime values are equal, and an Order is "less than" another Order if its
   * prepTime is shorter than the other Order's.
   * 
   * @return 1 if have greater prep time, -1 if smaller
   */
